...
import IntroSlidesComposer from '../constants/IntroSlides';
...
export default class IntroScreen extends React.Component {
  constructor(props) {
    ...
    this.onDone = () => {
      this.state.slides.pop().slice(0, 1);
      console.log('INTRO COMPLETED ==', this.state.slides)
